...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark wow fadeIn" data-wow-delay="0.15s">
        <div class="container">
            <a class="navbar-brand font-weight-bold title" href="#">Kolor</a>
                ...
                <div class="col-12 text-center mt-2">
                    <div class="text-black wow fadeInDown">
                        <div class="log pl-5 pb-4 pr-5 pt-2" style="background-color: rgba(255,255,255,0.5);">
                            <form method="post" action="insert_kolory_do.php">
                        <div class="form-group">
                            ...
                            <?php
                            if(isset($_SESSION['blad_kolor'])){
                                echo $_SESSION['blad_kolor'];
                                unset($_SESSION['blad_kolor']);
                            }
                            ?>
                        </div>
