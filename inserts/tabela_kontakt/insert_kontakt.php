...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark wow fadeIn" data-wow-delay="0.15s">
        <div class="container">
            <a class="navbar-brand font-weight-bold title" href="#">Kontakt</a>
                ...
                <div class="col-12 text-center mt-2">
                    <div class="text-black wow fadeInDown">
                        <div class="log pl-5 pb-4 pr-5 pt-2" style="background-color: rgba(255,255,255,0.5);">
                            <form method="post" action="insert_kontakt_do.php">
                                <div class="form-group">
                                    <h4><strong>Imie Kontakt: </strong></h4>
                                    <input type="text" name="zmienna1" class="form-control" id="imie">

                                </div>
                                <div class="form-group">
                                    <h4><strong>Email Kontakt: </strong></h4>
                                    <input type="text" name="zmienna2" class="form-control" id="imie">

                                </div>
                                <div class="form-group">
                                    <h4><strong>Temat Kontakt: </strong></h4>
                                    <input type="text" name="zmienna3" class="form-control" id="imie">

                                </div>
                                <div class="form-group">
                                    <h4><strong>Tresc Kontakt: </strong></h4>
                            ...
                            <?php
                            if(isset($_SESSION['blad_kontaktu'])){
                                echo $_SESSION['blad_kontaktu'];
                                unset($_SESSION['blad_kontaktu']);
                            }
                            ?>
                        </div>
