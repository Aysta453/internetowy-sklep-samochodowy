...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark wow fadeIn" data-wow-delay="0.15s">
        <div class="container">
            <a class="navbar-brand font-weight-bold title" href="#">Marka</a>
                ...
                <div class="col-12 text-center mt-2">
                    <div class="text-black wow fadeInDown">
                        <div class="log pl-5 pb-4 pr-5 pt-2" style="background-color: rgba(255,255,255,0.5);">
                            <?php echo "<form method=\"POST\" action=\"update_marki_do.php?id=".$pobrana."\">"; ?>
                                <div class="form-group">
                                    <h4><strong>Marka: </strong></h4>
                                    <input type="text" name="nazwa_marki" class="form-control" id="imie">
                            ...
                            <?php
                            if(isset($_SESSION['blad_marka1'])){
                                echo $_SESSION['blad_marka1'];
                                unset($_SESSION['blad_marka1']);
                            }
                            ?>
                        </div>
                    </div>
