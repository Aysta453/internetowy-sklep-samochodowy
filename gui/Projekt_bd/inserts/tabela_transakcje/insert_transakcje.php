...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark wow fadeIn" data-wow-delay="0.15s">
        <div class="container">
            <a class="navbar-brand font-weight-bold title" href="#">Transakcje</a>
                ...
                <div class="col-12 text-center mt-2">
                    <div class="text-black wow fadeInDown">
                        <div class="log pl-5 pb-4 pr-5 pt-2" style="background-color: rgba(255,255,255,0.5);">
                            <form method="post" action="insert_transakcje_do.php">
                                <div class="form-group">
                                    <h4><strong>Klient: </strong></h4>
                                    <select name="zmienna1">
                                        ...
                                        if(!$conn){
                                            ...
                                            $sql = "SELECT count(*) as var1 from klient";
                                            ...
                                            do {
                                                ...
                                                oci_free_statement($stid);
                                                echo "<tr>";
                                                echo "<option value=" . $var1 . ">" .$name1." ".$name2. " " . $name3 ." ".$name4." ". $name5 ." ".$name6. " ".$name7."</option>";
                                                $var1++;
                                            } while ($var1 <= $var2);
                                            oci_close($conn);
                                        }
