...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark wow fadeIn" data-wow-delay="0.15s">
        <div class="container">
            <a class="navbar-brand font-weight-bold title" href="#">Silniki</a>
                ...
                <div class="col-12 text-center mt-2">
                    <div class="text-black wow fadeInDown">
                        <div class="log pl-5 pb-4 pr-5 pt-2" style="background-color: rgba(255,255,255,0.5);">
                            <form method="post" action="insert_silniki_do.php">
                                <div class="form-group">
                                    <h4><strong>Nazwa: </strong></h4>
                                    <input type="text" name="nazwa_silnika" class="form-control" id="imie">

                                </div>
                                <div class="form-group">
                                    <h4><strong>Typ: </strong></h4>
                                    <input type="text" name="typ_silnika" class="form-control" id="imie">

                                </div>
                                <div class="form-group">
                                    <h4><strong>Moc: </strong></h4>
                                    <input type="text" name="moc" class="form-control" id="imie">

                                </div>
                                <div class="form-group">
                                    <h4><strong>Pojemnosc: </strong></h4>
                                    <input type="text" name="pojemnosc" class="form-control" id="imie">

                                </div>
                                <button type="submit" class="btn btn-primary">Wprowadz</button>
                            </form>
                            <?php
                            if(isset($_SESSION['blad_silnika'])){
                                echo $_SESSION['blad_silnika'];
                                unset($_SESSION['blad_silnika']);
                            }
                            ?>
                        </div>
