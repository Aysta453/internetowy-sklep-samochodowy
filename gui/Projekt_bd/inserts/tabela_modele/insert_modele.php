                ...
                <div class="col-12 text-center mt-2">
                    <div class="text-black wow fadeInDown">
                        <div class="log pl-5 pb-4 pr-5 pt-2" style="background-color: rgba(255,255,255,0.5);">
                            <form method="post" action="insert_modele_do.php">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nazwa_modelu" class="form-control" id="imie">
                            ...
                            <?php
                            if(isset($_SESSION['blad_model'])){
                                echo $_SESSION['blad_model'];
                                unset($_SESSION['blad_model']);
                            }
                            ?>
                        </div>
